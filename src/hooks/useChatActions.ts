...
export function useChatActions(loadConversations: () => Promise<void>) {
  ...
  const handleSendMessage = useCallback(
    async (text: string) => {
      const { activeConvId: convId, streaming: isStreaming } =
    ...
    [setChatMessages, setStreaming, setStreamingText, loadConversations],
  );
